...
description: "A skill for setting up Codex tooling for ai-agent-camp. Triggered by requests like 'set up MCP server', 'install hooks', 'Codex configuration', 'tool setup', 'install Codex CLI', etc."
version: 1.0.0
...
Codex CLI is a terminal-based AI coding assistant provided by OpenAI.
