...
description: "A skill for safely syncing ai-agent-camp course materials from upstream. Triggered by requests like 'update materials', 'sync from upstream', 'sync courses', 'git pull', 'update course materials', etc."
version: 1.0.0
