---
name: plotly
description: "Skill for creating interactive graphs and dashboards with Plotly. Supports hover, zoom, and pan. Triggered by requests like 'interactive graph', 'chart with plotly', 'dynamic chart', etc."
triggers:
