---
name: sql-queries
description: "Skill for writing accurate, high-performance SQL across major data warehouse dialects. Triggered by requests like 'Write SQL', 'Optimize query', 'Aggregate in BigQuery', etc."
triggers:
  - Write SQL
  - Optimize query
