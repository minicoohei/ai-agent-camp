...
description: "A skill for safely managing environment variables and credentials in ai-agent-camp. Triggered by requests like 'set API key', 'manage .env', 'set environment variables', 'use credential manager', 'manage secrets', etc."
version: 1.0.0
