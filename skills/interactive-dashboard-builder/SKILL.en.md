...
description: "Skill for building interactive HTML dashboards using Chart.js. Triggered by requests like 'create a dashboard,' 'interactive report,' 'create HTML charts,' etc. Generates standalone HTML with filters, charts, and professional styling."
