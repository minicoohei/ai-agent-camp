...
description: "Skill for statistical test selection, assumption checking, power analysis, and APA-format reporting. Triggered by requests like 'Run statistical analysis', 'Execute t-test', 'Choose the right test', etc."
triggers:
...
print(f"P(mu_1 > mu_2 | data) = {prob_greater:.3f}")
...
on test scores, F(2, 147) = 8.45, p < .001, partial eta-squared = .10. Post hoc
...
not (B = 0.15, SE = 0.12, beta = .08, t = 1.25, p = .21, 95% CI [-0.09, 0.39]).
...
BF_10 = 45.3 provided very strong evidence for a difference between
...
4. **Confusing significance with importance**: p < .05 does not equal meaningful effect
...
10. **Overinterpreting non-significant results**: Absence of evidence does not equal evidence of absence
