---
name: matplotlib
description: "Skill for creating graphs and charts with Python's matplotlib. Supports PNG/PDF/SVG output. Triggered by requests like 'create a graph', 'draw a chart', 'visualize data', 'matplotlib', etc."
triggers:
  - create a graph
  - draw a chart
  - visualize data
