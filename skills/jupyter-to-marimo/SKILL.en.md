...
description: "Skill for converting Jupyter notebooks (.ipynb) to marimo notebooks (.py). Triggered by requests like 'convert Jupyter,' 'ipynb to marimo,' 'notebook conversion,' etc."
...
## Trigger Words
"Jupyter conversion," "ipynb conversion," "convert to marimo," "notebook conversion"
