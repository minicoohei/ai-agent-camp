...
| score | grade | file | top blockers |
|---:|:--:|---|---|
| 70 | B | `commands/lesson/check-setup.md` | AskQuestion×7; Restart×2; Namespace×5; declared:incompatible |
| 70 | B | `commands/lesson/setup-bigquery.md` | AskQuestion×15; OAuth×15; Secret×1; Install×1; declared:incompatible |
| 70 | B | `commands/lesson/setup-clasp.md` | AskQuestion×17; OAuth×8; Namespace×1; declared:incompatible |
...
| 70 | B | `commands/lesson/setup-remotion.md` | AskQuestion×10; OAuth×1; Install×1; declared:incompatible |
| 70 | B | `commands/lesson/setup-slack.md` | AskQuestion×16; OAuth×17; Secret×4; declared:incompatible |
| 70 | B | `commands/lesson/setup-start.md` | AskQuestion×10; OAuth×3; Install×1; Namespace×6; declared:incompatible |
| 70 | B | `commands/lesson/setup-typefully.md` | AskQuestion×15; OAuth×1; Secret×17; Namespace×1; declared:incompatible |
| 70 | B | `commands/lesson/setup-vercel.md` | AskQuestion×16; OAuth×12; Install×4; Namespace×2; declared:incompatible |
| 70 | B | `commands/lesson/setup-x-api.md` | AskQuestion×15; OAuth×1; Secret×15; Namespace×1; declared:incompatible |
| 70 | B | `commands/lesson/start-0-1.md` | AskQuestion×6; OAuth×2; declared:incompatible |
| 70 | B | `commands/lesson/start-0-2.md` | AskQuestion×4; Restart×1; declared:incompatible |
| 70 | B | `commands/lesson/start-0-7.md` | AskQuestion×8; OAuth×2; Install×3; Namespace×1; declared:incompatible |
| 70 | B | `commands/lesson/start-10-1.md` | AskQuestion×23; OAuth×2; declared:incompatible |
| 70 | B | `commands/lesson/start-11-2.md` | AskQuestion×23; OAuth×1; declared:incompatible |
| 70 | B | `commands/lesson/start-11-3.md` | AskQuestion×9; OAuth×1; declared:incompatible |
