...
1. Verifica si ya existe en [Issues](https://github.com/TokenPocket/ai-agent-camp/issues)
...
| Metodo | Uso |
|--------|-----|
| [GitHub Issues](https://github.com/TokenPocket/ai-agent-camp/issues) | Reportar errores, solicitar funciones, preguntas tecnicas |
| [Discussions](https://github.com/TokenPocket/ai-agent-camp/discussions) | Preguntas generales, intercambio de informacion, propuesta de ideas |
...
- **Repositorio oficial**: [github.com/TokenPocket/ai-agent-camp](https://github.com/TokenPocket/ai-agent-camp)
- **Issue tracker**: [Issues](https://github.com/TokenPocket/ai-agent-camp/issues)
- **Notas de version**: [Releases](https://github.com/TokenPocket/ai-agent-camp/releases)
