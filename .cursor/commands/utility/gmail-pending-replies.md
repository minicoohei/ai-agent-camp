...
| アカウント | パス | 自分のアドレス |
|------------|------|----------------|
| aibrain | `output/gmail/aibrain/` | `kohei@aibrainpartners.jp` |
| infobox | `output/gmail/infobox/` | 対応するアドレス |
...
```
📋 返信が必要なメール（aibrain）: 2 件
📅 対象期間: 過去7日間

======================================================================

1. AIエージェントを活用した生産性向上事例について ⚠️ 要対応
   📅 2026-01-27 10:13
   👤 遠藤 一哲 <kazuaki.endo@ycp.com>
   📋 タイプ: 依頼・タスク
   💬 事例提供のお願い（スクリーンショット込み）
   🔗 https://mail.google.com/mail/u/0/#inbox/xxx

2. 国交省案件 ３月末の着地について
   📅 2026-01-23 13:53
   👤 小野 貴紀 <takanori.ono@ycp.com>
   📢 タイプ: 情報共有（CC）
   💬 土屋さんとの会話内容共有
...
```
---
## 返信案: AIエージェントを活用した生産性向上事例について

件名: Re: YCP：AIエージェントを活用した生産性向上事例について
