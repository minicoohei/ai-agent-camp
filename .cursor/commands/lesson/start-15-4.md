---
description: "When the user says /start-15-4 — Module 15 Lesson 15-4: 絵コンテからアニメ動画を生成する（Gemini画像 + Kling/Veo I2V + FFmpeg結合）"
...
```json
{
  ...
  "questions": [{
    ...
    "options": [
      {"id": "next_auto", "label": "次のセクション（/start-15-5 スライド解説動画）"},
