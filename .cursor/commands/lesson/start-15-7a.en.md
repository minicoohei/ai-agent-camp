...
> Pairs 1:1 with the aiagent-course Module 15 slide `Lesson 15-7a`. Refer to the
...
1. Open the matching aiagent-course slide showing `Lesson 15-7a: start-15-7a`.
