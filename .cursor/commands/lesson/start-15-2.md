---
description: "When the user says /start-15-2 — Module 15 Lesson 15-2: 動画AIエンジンの全体像を理解し、fal.aiの使い方を学ぶ"
...
実際のAPI呼び出しは 15-3 以降のプロジェクトレッスンで必要な分だけ行います。
...
```json
{
  ...
  "questions": [{
    ...
    "options": [
      {"id": "next_73", "label": "15-3: プロダクト紹介動画（グリーンスクリーン合成）"},
      {"id": "next_74", "label": "15-4: 絵コンテアニメ動画"},
      {"id": "next_75", "label": "15-5: スライド解説動画（Remotion）"},
