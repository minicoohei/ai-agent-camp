---
description: "Lesson command — start-15-7c"
duration: "~30 min"
...
# /start-15-7c -- Lesson 15-7c: start-15-7c

> Apareja 1:1 con la slide `Lesson 15-7c` del Module 15 de aiagent-course. Para el
...
1. Abre la slide correspondiente en aiagent-course con `Lesson 15-7c: start-15-7c`.
...
- fal / generación de vídeo / sincronización de escenas
