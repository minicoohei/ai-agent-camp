---
description: "Lesson command — Remotion + SRTキャプション"
duration: "約25分"
...
# /start-15-12 -- Lesson 15-12: Remotion + SRTキャプション

> aiagent-course Module 15 のスライド `Lesson 15-12` と一対一対応。詳細はスライド本体を参照。

## このレッスンでやること

API従量課金を抑えつつ、SRT（字幕用ファイル）を読み込んでキャプション入り動画を書き出します。

## 進め方

1. aiagent-course の対応スライドを開いて `Lesson 15-12: Remotion + SRTキャプション` を表示
