---
description: "Lesson command — start-15-7b"
duration: "~30 min"
...
# /start-15-7b -- Lesson 15-7b: start-15-7b

> Apareja 1:1 con la slide `Lesson 15-7b` del Module 15 de aiagent-course. Para el
...
1. Abre la slide correspondiente en aiagent-course con `Lesson 15-7b: start-15-7b`.
