---
name: code-reviewer
description: "An automated code review skill supporting TypeScript, JavaScript, Python, Go, Swift, and Kotlin. PR complexity/risk analysis, SOLID violation and code smell detection, and review report generation. Triggered by requests like 'review code', 'analyze PR', 'code quality check', 'review report', etc."
