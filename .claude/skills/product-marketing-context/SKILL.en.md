...
version: 1.0.0
description: "A skill that creates and updates product marketing context documents. Triggered by requests like 'Create marketing context', 'Organize positioning', 'Summarize product information'."
triggers:
  - Create marketing context
  - Organize positioning
