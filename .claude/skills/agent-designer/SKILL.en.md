---
name: agent-designer
description: "A toolkit for designing multi-agent system architectures. Triggered by requests like 'design an agent', 'multi-agent configuration', 'agent architecture', 'orchestration design', etc."
