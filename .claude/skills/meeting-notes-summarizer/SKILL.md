...
description: 会議テキストやメモから構造化された議事録を自動生成するスキル。参加者、議題、決定事項、アクション項目、次回予定をMarkdownで整理したいときに使う。「議事録をまとめて」「会議メモを整理して」「アクション項目を抽出して」「ミーティングノートをまとめて」「ミーティングノートを構造化して」「この会議の要点を整理して」「この会議の要点をまとめて」「決定事項をリストアップして」と依頼されたときに使用する。
---
