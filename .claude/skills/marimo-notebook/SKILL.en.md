...
description: "Skill for creating marimo notebooks as Python files in the correct format. Triggered by requests like 'create a marimo notebook', 'interactive notebook', 'Python notebook', etc."
triggers:
  - create a marimo notebook
  - interactive notebook
  - Python notebook creation
  - marimo-notebook
  - marimo
  - create a notebook
...
## Trigger Words
"marimo notebook", "interactive notebook", "Python notebook", "marimo"
