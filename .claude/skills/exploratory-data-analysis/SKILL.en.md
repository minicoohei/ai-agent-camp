...
description: "Exploratory data analysis (EDA) skill supporting 200+ file formats. Triggered by requests like 'analyze the data,' 'run EDA,' 'examine the file contents,' etc. Generates reports including automatic file detection, quality assessment, statistical summaries, and visualization recommendations."
license: MIT license
metadata:
...
## Trigger Words
"Data analysis," "EDA," "file parsing," "data exploration," "CSV analysis"
