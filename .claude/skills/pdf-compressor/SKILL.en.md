---
name: pdf-compressor
description: "Skill for compressing large PDF files. Up to 98% file size reduction. Triggered by requests like 'compress the PDF', 'make the PDF lighter', 'reduce the file size', etc."
triggers:
  - compress the PDF
  - make the PDF lighter
  - reduce the file size
  - pdf-compressor
  - PDF compress
  - the PDF is too heavy
---
...
- System: poppler (for pdf2image)
  ...
  - Windows: Get binaries from [poppler-windows](https://github.com/oschwartz10612/poppler-windows) and add to PATH
