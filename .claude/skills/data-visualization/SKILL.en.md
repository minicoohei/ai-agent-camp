...
description: "Skill for data visualization using Python (matplotlib, seaborn, plotly). Triggered by requests like 'create a chart,' 'make a graph,' 'visualize the data,' etc. Includes chart selection, design principles, and accessibility considerations."
