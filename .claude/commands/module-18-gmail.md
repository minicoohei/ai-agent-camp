...
1. 未返信メールの検出（教材のオプションに合わせた日数・件数）。
2. 優先度の整理と、返信ドラフト案の提示（Gemini 等はスキルに従う）。
3. **送信はユーザー承認後のみ**と明示する。

## 参照

- コース: `slideId=lesson-18-3`（例: `/ja/course/module-18?slideId=lesson-18-3`）
