...
1. Detect unreplied emails (matching the course options for days/count).
2. Organize by priority and present reply draft suggestions (use Gemini etc. per skill guidelines).
3. **Explicitly state that sending requires user approval.**

## References

- Course: `slideId=lesson-18-3` (e.g., `/en/course/module-18?slideId=lesson-18-3`)
