...
1. Detectar correos sin responder (según las opciones del curso para días/cantidad).
2. Organizar por prioridad y presentar sugerencias de borradores de respuesta (usar Gemini, etc. según las directrices del skill).
3. **Indicar explícitamente que el envío requiere la aprobación del usuario.**

## Referencias

- Curso: `slideId=lesson-18-3` (ej.: `/es/course/module-18?slideId=lesson-18-3`)
