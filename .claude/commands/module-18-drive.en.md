...
1. Retrieve folder/file listings.
2. Upload, download, and convert formats (e.g., xlsx export) following the course material.
3. Summarize result paths and important notes (permissions, sharing scope).

## References

- Course: `slideId=lesson-18-4` (e.g., `/en/course/module-18?slideId=lesson-18-4`)
