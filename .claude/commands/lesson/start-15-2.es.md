---
description: "When the user says /start-15-2 — Module 15 Lesson 15-2: Comprender el panorama de motores de IA de video y aprender a usar fal.ai"
...
# 15-2: Panorama de Motores de IA de Video

## Lo Que Hará en Esta Sesión

Bienvenido a **Lección 15-2: Panorama de Motores de IA de Video**!
...
Las llamadas reales a la API se realizarán solo según sea necesario en las lecciones de proyecto a partir de 15-3.
...
```json
{
  ...
  "questions": [{
    ...
    "options": [
      {"id": "next_73", "label": "15-3: Video de presentacion de producto (composicion con pantalla verde)"},
      {"id": "next_74", "label": "15-4: Video anime con storyboard"},
      {"id": "next_75", "label": "15-5: Video de narracion de diapositivas (Remotion)"},
