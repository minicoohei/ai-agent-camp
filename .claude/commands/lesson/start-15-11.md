---
description: "Lesson command — Remotionで思い通りの動きにするには"
duration: "約30分"
...
# /start-15-11 -- Lesson 15-11: Remotionで思い通りの動きにするには

> aiagent-course Module 15 のスライド `Lesson 15-11` と一対一対応。詳細はスライド本体を参照。

## このレッスンでやること

参照リサーチと指示の書き方、カット割の習慣がクオ定に効くことをまとめます。

## 進め方

1. aiagent-course の対応スライドを開いて `Lesson 15-11: Remotionで思い通りの動きにするには` を表示
