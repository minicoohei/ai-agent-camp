---
description: "Lesson command — start-15-7a"
duration: "~30 min"
...
# /start-15-7a -- Lesson 15-7a: start-15-7a

> Apareja 1:1 con la slide `Lesson 15-7a` del Module 15 de aiagent-course. Para el
...
1. Abre la slide correspondiente en aiagent-course con `Lesson 15-7a: start-15-7a`.
