...
Aprenda a convertir los clips extraidos en la Lección 15-3 en materiales de marketing para redes sociales usando Remotion.
...
Combine con Clipper de la Lección 15-3 para una ejecución de extremo a extremo:
...
```json
{
  ...
  "questions": [{
    ...
    "options": [
      ...
      {"id": "next_window", "label": "Abrir en nueva ventana (/start-15-5)"},
