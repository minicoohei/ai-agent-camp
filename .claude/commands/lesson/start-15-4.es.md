---
description: "When the user says /start-15-4 — Module 15 Lesson 15-4: Generar video anime desde storyboard (Gemini Image + Kling/Veo I2V + FFmpeg)"
...
# 15-4: Video Anime con Storyboard

## Lo Que Hará en Esta Sesión

Bienvenido a **Lección 15-4: Video Anime con Storyboard**!
...
```json
{
  ...
  "questions": [{
    ...
    "options": [
      {"id": "next_auto", "label": "Siguiente seccion (/start-15-5 Video de narracion de diapositivas)"},
