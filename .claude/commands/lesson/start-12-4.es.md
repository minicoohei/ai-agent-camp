---
description: "When the user says /start-12-4 — Module 12 Lesson 12-4: Generacion automatizada de informes"
...
| Elemento | Contenido |
|------|------|
| Objetivo | **Resumir de forma estructurada** paginas y filas de BD obtenidas en **una o pocas solicitudes** a traves de Notion MCP / API para el chat |
| Duracion | ~35 min |
| Habilidades utilizadas | Notion MCP (search / fetch / query), ncli segun sea necesario |
| Requisitos previos | `/start-12-3` completada, Notion conectado |
| Pagina del curso | [Module 12: Notion](https://ai-agent.camp/es/course/module-12)  como referencia paralela |

**Flujo de la sesion:**
1. Reducir bases de datos o páginas a **un solo lote usando consultas/filtros** para la obtención
2. Resumir **puntos clave, cantidades y próximas acciones** como viñetas del JSON/texto obtenido
3. Para ahorrar tokens, seguir la regla de **no pegar el texto completo** y determinar el rango de cita

Al final de esta sesion, podra reproducir el flujo completo: "Obtener -> Resumir -> Devolver al usuario".
...
> **Cómo leer esta lección**: Los siguientes Steps incluyen ejemplos desde la creación hasta la actualización de bases de datos. Si ya tiene una BD, omita el Step 1 y practique siempre devolver un "resumen (cantidad, puntos clave, próximas acciones)" al chat **después de consultas y fetch**.
