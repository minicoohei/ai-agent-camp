---
description: "Lesson command — Remotion + SRT captions"
duration: "~25 min"
...
# /start-15-12 -- Lesson 15-12: Remotion + SRT captions

> Pairs 1:1 with the aiagent-course Module 15 slide `Lesson 15-12`. Refer to the
> slide for the full body.

## What this lesson covers

Burn in subtitles from SRT files while keeping API spend low.

## How to proceed

1. Open the matching aiagent-course slide showing `Lesson 15-12: Remotion + SRT captions`.
...
- Remotion / SRT / captions / local export
