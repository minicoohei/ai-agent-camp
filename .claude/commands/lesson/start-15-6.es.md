---
description: "When the user says /start-15-6 — Module 15 Lesson 15-6: Crear un video musical con IA (Suno + sincronización de ritmo + conversión de escenas a video)"
...
# Lección 15-6: Video Musical

## Lo Que Hará en Esta Sesión

Bienvenido a **Lección 15-6: Video Musical**!
...
```json
{
  ...
  "questions": [{
    ...
    "options": [
      {"id": "next_module", "label": "Siguiente modulo (/start-16-1 Automatizacion de correo/LINE)"},
