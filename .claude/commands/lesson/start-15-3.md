---
description: "When the user says /start-15-3 — Module 15 Lesson 15-3: プロダクト紹介動画を作成する（グリーンスクリーンアバター + スクショ合成）"
...
```json
{
  ...
  "questions": [{
    ...
    "options": [
      {"id": "next_auto", "label": "次のセクション（/start-15-4 絵コンテアニメ動画）"},
