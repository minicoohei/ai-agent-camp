---
description: "Lesson command — Getting the motion you imagine in Remotion"
duration: "~30 min"
...
# /start-15-11 -- Lesson 15-11: Getting the motion you imagine in Remotion

> Pairs 1:1 with the aiagent-course Module 15 slide `Lesson 15-11`. Refer to the
> slide for the full body.

## What this lesson covers

Reference research, tracing, and shot lists beat vague prompts.

## How to proceed

1. Open the matching aiagent-course slide showing `Lesson 15-11: Getting the motion you imagine in Remotion`.
