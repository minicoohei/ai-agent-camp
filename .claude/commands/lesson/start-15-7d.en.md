---
description: "Lesson command — start-15-7d"
duration: "~30 min"
...
# /start-15-7d -- Lesson 15-7d: start-15-7d

> Pairs 1:1 with the aiagent-course Module 15 slide `Lesson 15-7d`. Refer to the
...
1. Open the matching aiagent-course slide showing `Lesson 15-7d: start-15-7d`.
