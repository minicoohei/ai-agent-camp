---
description: "When the user says /start-15-3 — Module 15 Lesson 15-3: Create a product demo video (green screen avatar + screenshot compositing)"
...
# 15-3: Product Demo Video

## What You Will Do in This Session

Welcome to **Lesson 15-3: Product Demo Video**!
...
```json
{
  ...
  "questions": [{
    ...
    "options": [
      {"id": "next_auto", "label": "Next section (/start-15-4 Storyboard anime video)"},
