---
description: "Lesson command — Remotion + subtítulos SRT"
duration: "~25 min"
...
# /start-15-12 -- Lección 15-12: Remotion + subtítulos SRT

> Apareja 1:1 con la slide `Lección 15-12` del Module 15 de aiagent-course. Para el
> cuerpo completo, consulta la slide.

## Qué cubre esta lección

Incrusta subtítulos desde archivos SRT manteniendo bajo el gasto de API.

## Cómo avanzar

1. Abre la slide correspondiente en aiagent-course con `Lección 15-12: Remotion + subtítulos SRT`.
...
- Remotion / SRT / subtítulos / exportación local
