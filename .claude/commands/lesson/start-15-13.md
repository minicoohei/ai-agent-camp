---
description: "Lesson command — アニメーションとスライドショー"
duration: "約35分"
...
# /start-15-13 -- Lesson 15-13: アニメーションとスライドショー

> aiagent-course Module 15 のスライド `Lesson 15-13` と一対一対応。詳細はスライド本体を参照。

## このレッスンでやること

WebサイトのUIモーションやチャットのトーク演出、写真スライドショーなどをRemotionでMV風にまとめます。

## 進め方

1. aiagent-course の対応スライドを開いて `Lesson 15-13: アニメーションとスライドショー` を表示
...
- Remotion / UIアニメ / チャット演出 / スライドショー
- 演習用の静止画・スクショ・短いクリップは ai-agent-camp の資産ディレクトリを参照
- 参照リソース: 下記「参考リンク」
