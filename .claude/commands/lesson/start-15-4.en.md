---
description: "When the user says /start-15-4 — Module 15 Lesson 15-4: Generate anime video from storyboard (Gemini Image + Kling/Veo I2V + FFmpeg join)"
...
# 15-4: Storyboard Anime Video

## What You Will Do in This Session

Welcome to **Lesson 15-4: Storyboard Anime Video**!
...
```json
{
  ...
  "questions": [{
    ...
    "options": [
      {"id": "next_auto", "label": "Next section (/start-15-5 Slide narration video)"},
