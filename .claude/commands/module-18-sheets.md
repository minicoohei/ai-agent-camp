...
1. スプレッドシート ID と範囲を確認する（ユーザーに不足があれば質問）。
2. `get` 相当の操作でデータ取得・プレビュー・エクスポート。
3. 大量データ時は分割やプレビュー行数を調整する。

## 参照

- コース: `slideId=lesson-18-5`（例: `/ja/course/module-18?slideId=lesson-18-5`）
